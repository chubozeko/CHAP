export class WhileLoop{
  ...
  parseWhileLoopExpression( variables: any[] ){
    ...
    // LOGICAL Operators: &&, ||, !
    if( (this.whileExpression.indexOf('&&') != -1) || (this.whileExpression.indexOf('||') != -1) || (this.whileExpression.indexOf('!') != -1)
      || (this.whileExpression.indexOf('<') != -1) || (this.whileExpression.indexOf('>') != -1) || (this.whileExpression.indexOf('==') != -1)
      || (this.whileExpression.indexOf('<=') != -1) || (this.whileExpression.indexOf('>=') != -1) || (this.whileExpression.indexOf('!=') != -1)
      || (this.whileExpression.indexOf('+') != -1) || (this.whileExpression.indexOf('-') != -1) || (this.whileExpression.indexOf('*') != -1)
      || (this.whileExpression.indexOf('/') != -1) || (this.whileExpression.indexOf('%') != -1) ){ 
